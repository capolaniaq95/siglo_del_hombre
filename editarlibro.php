...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE libro SET id_categoria='$categoria', id_autor='$autor', titulo='$titulo', descripcion='$descripcion', fecha_publicacion='$fecha_publicacion', editorial='$editorial', precio='$precio', imagen='$imagen' WHERE id_libro='$id_libro'";
        ...
        <div class="custom-form-container">
          <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="date" class="form-control" id="fecha_publicacion" name="fecha_publicacion" value="<?php echo $libro['fecha_publicacion']; ?>" required>
            </div>
            <div class="form-group">
