...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 07, 2024 at 12:43 AM
...
--
ALTER TABLE `lineas_devolucion`
  MODIFY `id_linea_devolucion` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `devolucion`
  ...
  ADD CONSTRAINT `devolucion_ibfk_2` FOREIGN KEY (`id_devolucion`) REFERENCES `lineas_devolucion` (`id_devolucion`);
