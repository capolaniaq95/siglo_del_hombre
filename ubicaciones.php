    ...
    <div class="row justify-content-center">
      <div class="col-md-10">
        <div class="row justify-content-center mb-3">
          <div class="col-sm-10">
          <a href="agregarubi.php" class="btn btn-info">Agregar nuevo registro</a>
          </div>
                </div>
                <h2 class="text-center mb-4">Ubicaciones</h2>
                        ...
                        <?php if ($resultado->num_rows > 0) : ?>
                            <?php while ($fila = $resultado->fetch_assoc()) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="editarubi.php?id=<?php echo $fila["id_ubicacion"]; ?>" class="btn btn-sm btn-primary">
                                            <i class="fas fa-edit"></i> Editar
                                        </a>
                                        <a href="eliminarubi.php?id=<?php echo $fila["id_ubicacion"]; ?>" class="btn btn-sm btn-danger">
