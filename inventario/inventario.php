        ...
        <main class="flex-fill">
            <div class="container mt-4">
                ...
                <div class="d-flex bd-highlight mb-1">
                    ...
                    <div class="ml-auto pr-4 bd-highlight">
                        <form class="form-inline my-2 my-lg-0" method="POST" action="inventario.php">
                                <select class="form-control mr-1" id="filtro" name="filtro">
                                    ...
                                    <option value="ubicacion_origen">Origen</option>
                                    <option value="ubicacion_destino">Destino</option>
                                </select>
                ...
                <div class="table-container">
                    ...
                    if (isset($_GET['page'])){
                        ...
                        $sql = "SELECT
                                ...
                                INNER JOIN
                                    ubicacion AS ubicacion_destino
                                              ON movimiento_inventario.ubicacion_destino = ubicacion_destino.id_ubicacion
                                INNER JOIN
                                    ubicacion AS ubicacion_origen
                                              ON movimiento_inventario.ubicacion_origen = ubicacion_origen.id_ubicacion
                                ORDER BY movimiento_inventario.id_movimiento
                                DESC
